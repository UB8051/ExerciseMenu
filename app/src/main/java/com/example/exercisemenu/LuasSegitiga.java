...
public class LuasSegitiga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = (EditText)findViewById(R.id.alassegi2);
        t = (EditText)findViewById(R.id.tinggisegi2);
        hitung = (Button) findViewById(R.id.btnsegi2);
        hasil = (TextView)findViewById(R.id.hasilsegi2);
